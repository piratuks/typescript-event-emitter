 ...
 *
 * This function creates a UUID in the format of `xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx`,
 * which is a version 4 UUID. The randomness is derived from the current time and
 * an additional entropy source (`performance.now` if available).
 *
